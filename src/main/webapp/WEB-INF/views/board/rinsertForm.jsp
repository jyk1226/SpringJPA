	...
	<form action="rinsert" method="post">
		<table>
			...
			<tr>
				...
				<input type="text" name="indent" value="${ParentInfo.indent }" hidden>
				</td>
			</tr>
			<tr>
				<td></td>
